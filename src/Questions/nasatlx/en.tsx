const NASATLX_EN = {
  "info" : {
    ...
    "scales" : "You'll now be presented with a series of rating scales.",
    "evaluate" : "For each of the six scales, evaluate the task you recently performed by tapping on the scale's location that matches your experience. Each line has two endpoint descriptors that describe the scale.",
    "consider" : "Consider your responses carefully in distinguishing among the different task conditions, and consider each scale individually.",
